...
const translations = {
  'pt-BR': {
    ...
    aboutTitle: 'Sobre Mim',
        ...
        storyGamerDesc: 'Aprendi na prática como decisões ruins de design podem arruinar uma experiência inteira',
        ...
        storyCuriousDesc: 'Entender o "porquê" das ações dos seres humanos através da psicologia e neurologia me ajuda a criar soluções que engajam e convertem',
        aboutConclusion: 'Adoro aprender com projetos reais e transformar insights em melhorias. Se você busca um designer focado em entender pessoas e gerar valor de negócio, vamos trocar uma ideia.',
    ...
    toolJira: 'Jira',
        ...
        keyLearningsMapText: 'Foi um projeto bem direto onde identifiquei algo que me incomodava no dia a dia e criei uma solução mais prática. Nada revolucionário, mas funcional e útil.',
  ...
  'en': {
    ...
    aboutTitle: 'About Me',
        ...
        aboutIntro: 'Designer passionate about understanding how people interact with technology. UX graduate from Uninassau and Digital Systems and Media student at UFC.',
        ...
        storyGamerDesc: 'I learned firsthand how bad design decisions can ruin an entire experience',
        storyObserver: 'Compulsive observer',
        storyObserverDesc: 'I analyze every app I use and always think "How could this be better?"',
        storyCurious: 'Passionate about psychology',
        storyCuriousDesc: 'Understanding the "why" behind human actions through psychology and neurology helps me create solutions that engage and convert',
  ...
  'es': {
    ...
    aboutTitle: 'Sobre Mí',
        ...
        aboutIntro: 'Diseñador apasionado por entender cómo las personas interactúan con la tecnología. Graduado en UX por Uninassau y estudiante de Sistemas y Medios Digitales en la UFC.',
        ...
        storyGamerDesc: 'Aprendí de primera mano cómo las malas decisiones de diseño pueden arruinar toda una experiencia',
        storyObserver: 'Observador compulsivo',
        storyObserverDesc: 'Analizo cada app que uso y siempre pienso "¿Cómo podría ser esto mejor?"',
        storyCurious: 'Apasionado por la psicología',
        storyCuriousDesc: 'Entender el "porqué" de las acciones humanas a través de la psicología y neurología me ayuda a crear soluciones que involucran y convierten',
        aboutConclusion: 'Me encanta aprender con proyectos reales y convertir los insights en mejoras mensurables. Si buscas un diseñador enfocado en entender a las personas y generar valor para el negocio, conversemos.',
...
function initAnimations() {
    ...
    // Animação da tagline - NÃO incluir elementos com ID específicos
    ...
    // (Removido ajuste de visibilidade de elementos do typewriter)
    ...
    // Livros grid - Animação que NÃO interfere com hover effects
    gsap.from('.livro-card', {
        ...
        onComplete: function() {
            // Após animação, garantir que livros fiquem visíveis
            gsap.set('.livro-card', {
                opacity: 1,
                visibility: 'visible',
                clearProps: 'all'
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Simples verificação para garantir visibilidade
    setTimeout(() => {
        ...
        if (rotatingEl) {
            ...
            rotatingEl.style.visibility = 'visible';
        }
    }, 500);
...
function initPosterGallery() {
    ...
    const posterDescriptions = {
        'pt-BR': {
            aves: 'Fiz esse poster numa tarde que estava obcecado com a ideia de voo e liberdade. Acabei misturando umas texturas e deu nisso',
            caminhos: 'Estava pensando sobre as escolhas que a gente faz na vida e como cada direção leva a um lugar diferente, daí saiu essa composição tipográfica.',
            ondeflor: 'Comecei recortando umas flores que tinha em casa, depois digitalizei e brinquei no Photoshop. Gosto da mistura do analógico com digital.',
            empty: 'Ouvi a música "Empty" do Omar Apollo umas 50 vezes seguidas e quis capturar aquele sentimento de vazio, mas de forma visual.',
            unlucky: 'Um dia encontrei um gato preto na rua e fiquei pensando sobre superstições bobas. O poster meio que nasceu dessa reflexão sobre sorte e azar.'
        },
        'en': {
            aves: 'Made this poster on an afternoon when I was obsessed with the idea of flight and freedom. Ended up mixing some textures I had saved on my phone.',
            caminhos: 'I was thinking about the choices we make in life and how each direction takes us somewhere different. This typographic composition came out of that.',
            ondeflor: 'Started by cutting out flowers from an old magazine I had at home, then digitized it and played around in Photoshop. I like mixing analog with digital.',
            empty: 'Listened to Omar Apollo "Empty" about 50 times in a row and wanted to capture that feeling of emptiness, but visually.',
            unlucky: 'One day I found a black cat on the street and got thinking about silly superstitions. The poster kind of emerged from that reflection on luck and bad luck.'
        },
        'es': {
            aves: 'Hice este póster en una tarde cuando estaba obsesionado con la idea del vuelo y la libertad. Terminé mezclando unas texturas que tenía guardadas en el celular.',
            caminhos: 'Estaba pensando sobre las decisiones que tomamos en la vida y cómo cada dirección nos lleva a un lugar diferente. De ahí salió esta composición tipográfica.',
            ondeflor: 'Empecé recortando flores de una revista vieja que tenía en casa, después las digitalicé y jugué en Photoshop. Me gusta la mezcla de lo analógico con lo digital.',
            empty: 'Escuché "Empty" de Omar Apollo como 50 veces seguidas y quise capturar esa sensación de vacío, pero de forma visual.',
            unlucky: 'Un día encontré un gato negro en la calle y me puse a pensar sobre supersticiones tontas. El póster medio que nació de esa reflexión sobre suerte y mala suerte.'
        }
    };
