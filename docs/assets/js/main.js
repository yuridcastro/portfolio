...
const translations = {
  'pt-BR': {
    ...
    aboutTitle: 'Sobre Mim',
        ...
        storyObserverDesc: 'Analiso cada app que uso - e sempre penso "como isso poderia ser melhor?"',
        storyCurious: 'Curioso sobre comportamento',
        storyCuriousDesc: 'Entender o "porquê" das ações humanas me ajuda a criar soluções que realmente funcionam',
        aboutConclusion: 'Profissionalmente sou movido por resolver problemas práticos. No tempo livre, escrevo no Medium, desenho pôsteres, jogo uns joguinhos e sou o maior fã de Junji Ito do Brasil',
  ...
  'en': {
    ...
    aboutTitle: 'About Me',
        ...
        aboutConclusion: 'Professionally, I\'m driven by solving practical problems. In my free time, I write on Medium, design posters, play some games, and I\'m Brazil\'s biggest Junji Ito fan',
  ...
  'es': {
    ...
    aboutTitle: 'Sobre Mí',
        ...
        aboutConclusion: 'Profesionalmente me motiva resolver problemas prácticos. En mi tiempo libre, escribo en Medium, diseño pósteres, juego algunos juegos y soy el mayor fan de Junji Ito de Brasil',
