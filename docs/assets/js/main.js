...
const translations = {
  'pt-BR': {
    ...
    aboutTitle: 'Sobre Mim',
        aboutBio: 'Sou um UX Designer formado pela Uninassau e atualmente estudante de Sistemas e Mídias Digitais na UFC. Tenho interesse em psicologia do usuário e em como ajustes na experiência podem refletir em métricas de negócio tangíveis. Como profissional iniciante, construo meu portfólio através de projetos acadêmicos e pessoais baseados em testes e pequenos experimentos.',
        aboutDescription: 'Acredito que boas experiências nascem a partir das vivências. Minha curiosidade por histórias, jogos e comportamento humano alimenta diretamente meu trabalho como designer. Quando não estou criando interfaces, você pode me encontrar:',
        aboutConclusion: 'Adoro aprender com novos projetos e transformar insights em melhorias mensuráveis. Se você busca um designer focado em entender pessoas e gerar valor de negócio, vamos trocar uma ideia.',
